    ...
    <aside className="hidden w-[88px] shrink-0 flex-col items-center gap-1 border-r border-separator bg-surface py-5 md:flex lg:w-[260px] lg:items-stretch lg:px-3">
          ...
          return (
            ...
            >
              <span className="relative">
                ...
                {badge > 0 ? (
                  <span className="absolute -right-2 -top-1.5 flex h-[18px] min-w-[18px] items-center justify-center rounded-full bg-badge px-1 text-[11px] font-semibold leading-none text-white ring-2 ring-surface">
                    {formatCount(badge)}
                  </span>
                ) : null}
              </span>
      ...
      >
        ...
        <span className="hidden min-w-0 flex-col lg:flex">
          ...
          <span className="text-xs text-muted">в сети</span>
        </span>
      </Link>
    </aside>
  );
